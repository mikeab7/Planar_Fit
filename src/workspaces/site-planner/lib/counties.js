...
const COUNTIES_MAP_RAW = {
   ...
   * 19 states gets a boundary outline from that asset. `candidateCountiesForPoint`'s geometry-first
   ...
   * hoist Texas/Colorado sites do. That gap is pre-existing (true for every state outside TX/CO
   * today, wired or not) and out of scope for this item.
   *
