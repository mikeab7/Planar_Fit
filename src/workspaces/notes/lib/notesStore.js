 ...
 *  here still name the choice; `ConflictReview.jsx` is what now shows the two versions
 *  themselves (a redline by default), with the differing words marked — this function only had
 *  to say "read both below" instead of "pick", and gain a second parked-copy suffix so BOTH
