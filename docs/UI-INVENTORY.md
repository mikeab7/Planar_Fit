...
| 0px | 54px | 10.5px | 600 | `rgba(0, 0, 0, 0.06)` | `0px none rgb(27, 30, 38)` | Yield ×1 | src/workspaces/dashboard/Dashboard.jsx:35:import { fetchElementsForSites } from "./lib/dashboardYieldFetch.js"; (+more matches elsewhere, best-effort) |
...
| 0px | 54px | 10.5px | 600 | `rgba(255, 255, 255, 0.09)` | `0px none rgb(236, 239, 244)` | Yield ×1 | src/workspaces/dashboard/Dashboard.jsx:35:import { fetchElementsForSites } from "./lib/dashboardYieldFetch.js"; (+more matches elsewhere, best-effort) |
